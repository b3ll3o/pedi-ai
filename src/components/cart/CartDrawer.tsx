...
export function CartDrawer() {
  ...
  return (
    <div className={styles.overlay} onClick={closeCart} role="dialog" aria-modal="true" aria-label="Carrinho de compras">
        ...
        <div className={styles.content}>
          {items.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <p className={styles.emptySubtext}>Adicione itens do cardápio para fazer seu pedido</p>
            </div>
          ) : (
