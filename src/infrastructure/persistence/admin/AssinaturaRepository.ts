...
export class AssinaturaRepository implements IAssinaturaRepository {
  ...
  private recordToAssinatura(record: subscriptions): Assinatura {
    const props: AssinaturaProps = {
      ...
      assinaturaIniciadaEm: record.subscription_started_at ? new Date(record.subscription_started_at) : null,
      assinaturaExpiraEm: record.subscription_ends_at ? new Date(record.subscription_ends_at) : null,
