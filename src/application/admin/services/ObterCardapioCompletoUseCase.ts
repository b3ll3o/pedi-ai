 ...
 */
export class ObterCardapioCompletoUseCase
  implements UseCase<ObterCardapioCompletoInput, ObterCardapioCompletoOutput>
{
  constructor(
   ...
   */
  private async validarAcessoRestaurante(solicitanteId: string, restauranteId: string): Promise<void> {
