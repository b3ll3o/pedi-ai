...
export class ItemCardapio extends EntityClass<ItemCardapioProps> {
  ...
  atualizarPreco(novoPreco: Dinheiro): void {
    Object.assign(this.props, { preco: novoPreco, atualizadoEm: new Date(), version: this.props.version + 1 });
  }
  ...
  atualizarDescricao(novaDescricao: string | null): void {
    Object.assign(this.props, { descricao: novaDescricao, atualizadoEm: new Date(), version: this.props.version + 1 });
  }

  atualizarImagem(novaImagemUrl: string | null): void {
    Object.assign(this.props, { imagemUrl: novaImagemUrl, atualizadoEm: new Date(), version: this.props.version + 1 });
  }

  atualizarTipo(novoTipo: TipoItemCardapio): void {
    Object.assign(this.props, { tipo: novoTipo, atualizadoEm: new Date(), version: this.props.version + 1 });
  }

  atualizarLabels(novosLabels: LabelDietetico[]): void {
    Object.assign(this.props, { labelsDieteticos: [...novosLabels], atualizadoEm: new Date(), version: this.props.version + 1 });
  }
  ...
  static criar(props: Omit<ItemCardapioProps, 'id' | 'criadoEm' | 'atualizadoEm' | 'deletedAt' | 'version'>): ItemCardapio {
    const now = new Date();
