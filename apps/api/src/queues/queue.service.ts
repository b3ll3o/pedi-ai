...
export class QueueService {
  ...
  /**
   * Estatísticas agregadas de todas as filas (waiting/active/completed/failed/delayed).
   *
   * Usado pelo /health/redis endpoint (auditoria) e dashboards operacionais.
   * Retorna `null` quando Redis não está habilitado (modo no-op).
   */
