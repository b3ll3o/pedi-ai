...
export function TableQRCode({ table, qrData, onClose, onDownload }: TableQRCodeProps) {
    ...
    >
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.instructions}>
          <p>
            Este QR Code pode ser escaneado pelos clientes para acessar o cardápio digital desta
            mesa.
          </p>
        </div>
