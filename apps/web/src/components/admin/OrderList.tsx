...
export function OrderList({ orders, onViewDetails, onUpdateStatus, isLoading }: OrderListProps) {
                ...
                {order.status !== 'delivered' && order.status !== 'cancelled' && (
                  <span data-testid="update-status-button">
                    ...
                    >
                      ...
                      {order.status === 'paid' && (
                        <option value="preparing">Iniciar preparo</option>
                      )}
                      {order.status === 'preparing' && (
                        <option value="ready">Marcar como pronto</option>
                      )}
                      {order.status === 'ready' && (
