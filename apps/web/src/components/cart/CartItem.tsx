  ...
  return (
    <div className={styles.item} data-testid="cart-item">
      <div className={styles.imageContainer}>
        {hasImage ? (
          ...
          <div
            ...
            aria-hidden="true"
          >
            <span className={styles.placeholderInitial}>{item.name.charAt(0).toUpperCase()}</span>
          </div>
        )}
      </div>
      ...
      <div className={styles.content}>
        ...
        {item.notes && <p className={styles.notes}>Obs: {item.notes}</p>}
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.quantityControls}>
            ...
            <span className={styles.quantity} data-testid="quantity-input">
              {item.quantity}
            </span>
            <button
              className={styles.quantityButton}
