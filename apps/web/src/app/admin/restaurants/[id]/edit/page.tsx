...
export default function EditRestaurantPage() {
  ...
  const handleDeactivate = async () => {
    if (
      !confirm(
        'Tem certeza que deseja desativar este restaurante? Ele não aparecerá para os clientes, mas os dados serão mantidos.'
      )
    ) {
      return;
    }
        ...
        {restaurant && (
          <div className={styles.dangerZone}>
            ...
            <p className={styles.dangerDescription}>
              Desativar o restaurante fará com que ele não apareça mais para os clientes. Os dados
              serão mantidos para fins históricos.
            </p>
            <button
              type="button"
