...
export const metadata: Metadata = {
  ...
  description:
    'Cardápio digital que funciona offline para restaurantes. Pedidos em tempo real, QR Codes por mesa, Kitchen Display e muito mais. Teste grátis 14 dias.',
  alternates: {
    canonical: '/',
  },
  openGraph: {
    ...
    <div className={styles.page}>
      ...
      <section aria-labelledby="social-proof-title" className={styles.socialProof}>
        <div className={styles.container}>
          <p id="social-proof-title" className={styles.socialProofLabel}>
          ...
          <div className={styles.problemsGrid}>
            <div className={styles.problemCard}>
              ...
              <p className={styles.problemText}>
                Quando a internet cai, seu sistema de pedidos para. Você perde vendas e precisa
            ...
            <div className={styles.problemCard}>
              ...
              <p className={styles.problemText}>
                Comandas impressas se perdem, pedidos demoram para chegar e clientes ficam
                esperando.
              </p>
            </div>
            <div className={styles.problemCard}>
