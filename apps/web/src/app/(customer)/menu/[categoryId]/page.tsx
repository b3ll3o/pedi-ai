...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Confira todos os produtos disponíveis nesta categoria do cardápio digital do restaurante. Adicione ao carrinho e faça seu pedido com segurança mesmo offline.',
    alternates: {
