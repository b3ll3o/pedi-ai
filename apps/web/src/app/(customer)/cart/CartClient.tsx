    ...
    <div className={styles.container} data-testid="cart-container">
      ...
      {isEmpty ? (
        <div className={styles.emptyState}>
          ...
          <h2 className={styles.emptyTitle} data-testid="empty-cart-message">
            Carrinho vazio
          </h2>
          <p className={styles.emptyText}>Adicione itens do cardápio para fazer seu pedido.</p>
          <button className={styles.emptyButton} onClick={handleBackToMenu} type="button">
            Voltar ao cardápio
          </button>
        </div>
      ) : (
