...
} from '@/domain/admin/value-objects/ConfiguracoesRestaurante';
...
describe('ConfiguracoesRestaurante', () => {
  ...
  describe('getters', () => {
    ...
    it('deve retornar taxaEntrega', () => {
      expect(config.taxaEntrega).toBe(5.5);
    });

    it('deve retornar valorMinimoPedido', () => {
      expect(config.valorMinimoPedido).toBe(25.0);
    });
