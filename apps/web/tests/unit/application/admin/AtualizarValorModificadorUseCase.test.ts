...
describe('AtualizarValorModificadorUseCase', () => {
  ...
  describe('execute', () => {
    it('deve atualizar valor de modificador com dados válidos', async () => {
      ...
      const { AtualizarValorModificadorUseCase } =
        await import('@/application/admin/services/AtualizarValorModificadorUseCase');
