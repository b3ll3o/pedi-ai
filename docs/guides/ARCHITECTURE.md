...
│   └─────────────────────────────────────────────────────────────────────┘   │
│                                                                              │
│   Estrutura: apps/web/src/application/[bounded-context]/services/*.ts                  │
│                                                                              │
...
```typescript
// apps/web/src/domain/pedido/value-objects/Dinheiro.ts
...
```typescript
// apps/web/src/domain/pedido/aggregates/PedidoAggregate.ts
...
```typescript
// apps/web/src/domain/pedido/events/PedidoCriadoEvent.ts
...
```typescript
// apps/web/src/domain/pedido/repositories/IPedidoRepository.ts
...
```
apps/web/src/application/[bounded-context]/services/
...
```typescript
// apps/web/src/application/shared/types/UseCase.ts
...
```typescript
// apps/web/src/application/pedido/services/CriarPedidoUseCase.ts
...
```typescript
// apps/web/src/infrastructure/persistence/pedido/PedidoRepository.ts
...
```typescript
// apps/web/src/presentation/hooks/usePedido.ts (hipotético - ainda não migrado)
...
```typescript
// ✅ PERMITIDO em apps/web/src/domain/pedido/entities/Pedido.ts
...
```typescript
// apps/web/src/domain/mesa/aggregates/MesaAggregate.ts
...
_Documento atualizado em 2026-04-27_
