...
**Fluxos E2E:** `apps/web/tests/admin/auth.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/multi-restaurant.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/restaurant-reactivate.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/categories.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/products.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/modifier-groups.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/combos-admin.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/table-qr.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/orders.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/waiter/kitchen.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/realtime-updates.spec.ts`
...
**Fluxos E2E:** `apps/web/tests/admin/analytics.spec.ts`
...
| --------------------- | ---------------------------------------------------- | ----------------- |
| auth (admin)          | `apps/web/tests/admin/auth.spec.ts`                  | @smoke, @critical |
| multi-restaurant      | `apps/web/tests/admin/multi-restaurant.spec.ts`      | —                 |
| restaurant-reactivate | `apps/web/tests/admin/restaurant-reactivate.spec.ts` | —                 |
| categories            | `apps/web/tests/admin/categories.spec.ts`            | —                 |
| products              | `apps/web/tests/admin/products.spec.ts`              | —                 |
| modifier-groups       | `apps/web/tests/admin/modifier-groups.spec.ts`       | —                 |
| combos-admin          | `apps/web/tests/admin/combos-admin.spec.ts`          | —                 |
| table-qr              | `apps/web/tests/admin/table-qr.spec.ts`              | —                 |
| orders                | `apps/web/tests/admin/orders.spec.ts`                | —                 |
| realtime-updates      | `apps/web/tests/admin/realtime-updates.spec.ts`      | —                 |
| analytics             | `apps/web/tests/admin/analytics.spec.ts`             | —                 |
| kitchen (garçom)      | `apps/web/tests/waiter/kitchen.spec.ts`              | @slow             |
| offline-restaurant    | `apps/web/tests/admin/offline-restaurant.spec.ts`    | —                 |
...
- [Guia de Offline](./guides/OFFLINE.md)
- [Guia Realtime](./guides/REALTIME.md)
